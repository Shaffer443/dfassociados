            ...
            <section>
                <form action="envio.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nome" class="form-control" id="exampleFormControlInput1" placeholder="Nome e Sobrenome">
                    </div>
                    <!-- Email -->
                    <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 page-more-info">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <a href="#" style="text-decoration: none; color: #CD9F60;"></br><b>contato@dfassociados.com.br</b></a>  
                        ...
                        <div class="col-md-6 col-lg-3 page-more-info">
                            ...
                            <ul>
                                ...
                                <!-- <li><a href="#">Contato</a></li> Já esta na página de contato--> 
                            </ul>
                        </div>
